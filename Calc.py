...
imperial_conversion_volume = {
    ...
    "gal_to_c": , "c_to_gal": ,
    "gal_to_oz": , "oz_to_gal": ,
    "gal_to_tbsp": , "tbsp_to_gal": ,
    "gal_to_tsp": , "tsp_to_gal": ,
    "gal_to_cubic_meter": , "cubic_meter_to_gal": ,
    "gal_to_l": , "l_to_gal": ,
    "gal_to_ml": , "ml_to_gal": ,
    "gal_to_imperial_gal": , "imperial_gal_to_gal": ,
    "gal_to_imperial_qt": , "imperial_qt_to_gal": ,
    "gal_to_imperial_pt": , "imperial_pt_to_gal": ,
    "gal_to_imperial_c": , "imperial_c_to_gal": ,
    "gal_to_imperial_oz": , "imperial_oz_to_gal": ,
    "gal_to_imperial_tbsp": , "imperial_tbsp_to_gal": ,
    "gal_to_imperial_tsp": , "imperial_tsp_to_gal": ,
    "gal_to_cubic_foot": , "cubic_foot_to_gal": ,
    "gal_to_cubic_inch": , "cubic_inch_to_gal": ,
