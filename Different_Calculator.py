...
metric_conversion = {
    ...
    "mega": 1e6, "kilo": 1e3, "hecto": 1e2, "deca": 1e1, "base": 1, "deci": 1e-1,
...
def get_base_unit():
    """Gets a valid base unit from the user."""
    while True:
...
def get_conversion_value():
    """Gets a valid numeric value for conversion."""
    while True:
        try:
...
def metric_conversion_prompt():
    """Handles metric unit conversion."""
...
def get_float(prompt):
    """Prompts user for a float input with validation."""
    while True:
        try:
...
def calculate_volume():
    """Handles volume calculations for various 3D shapes."""
